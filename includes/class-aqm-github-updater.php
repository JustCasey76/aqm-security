...
class AQM_GitHub_Updater {
    ...
    public function __construct($config = []) {
        $defaults = [
            ...
            'api_url' => 'https://api.github.com/repos/AQ-Marketing/aqm-plugins',
            'raw_url' => 'https://raw.github.com/AQ-Marketing/aqm-plugins/main',
            'github_url' => 'https://github.com/AQ-Marketing/aqm-plugins',
            'zip_url' => 'https://github.com/AQ-Marketing/aqm-plugins/archive/main.zip',
            'sslverify' => true,
            'requires' => '5.6',
            'tested' => '6.4',
            'readme' => 'README.md',
